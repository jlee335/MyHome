...
public abstract class BaseLoaderCallback implements LoaderCallbackInterface {
    ...
    public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case LoaderCallbackInterface.MARKET_ERROR:
            {
                ...
                androidx.appcompat.app.AlertDialog MarketErrorMessage = new androidx.appcompat.app.AlertDialog.Builder(mAppContext).create();
                MarketErrorMessage.setTitle("OpenCV Manager");
                MarketErrorMessage.setMessage("Package installation failed!");
                MarketErrorMessage.setCancelable(false); // This blocks the 'BACK' button
                MarketErrorMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "OK", new OnClickListener() {
            ...
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION:
            {
                ...
                androidx.appcompat.app.AlertDialog IncomatibilityMessage = new androidx.appcompat.app.AlertDialog.Builder(mAppContext).create();
                ...
                IncomatibilityMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "OK", new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
                });
            ...
            default:
            {
                ...
                androidx.appcompat.app.AlertDialog InitFailedDialog = new AlertDialog.Builder(mAppContext).create();
    ...
    public void onPackageInstall(final int operation, final InstallCallbackInterface callback)
    {
        switch (operation)
        {
            ...
            {
                androidx.appcompat.app.AlertDialog InstallMessage = new AlertDialog.Builder(mAppContext).create();
                ...
                InstallMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "Yes", new OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int which)
                    {
                        callback.install();
                ...
                InstallMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_NEGATIVE, "No", new OnClickListener() {
            ...
            {
                AlertDialog WaitMessage = new androidx.appcompat.app.AlertDialog.Builder(mAppContext).create();
                ...
                WaitMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "Wait", new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        callback.wait_install();
                    }
                });
                WaitMessage.setButton(androidx.appcompat.app.AlertDialog.BUTTON_NEGATIVE, "Exit", new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        callback.cancel();
                    }
                });
